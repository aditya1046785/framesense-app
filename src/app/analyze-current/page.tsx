        ...
        <div className="flex flex-col min-h-screen bg-background text-foreground">
            ...
            <main className="flex-grow flex items-center justify-center p-4">
                <Card className="w-full max-w-2xl">
                    <CardHeader>
                        <CardTitle className="text-2xl font-headline">{t('analyzeCurrent.title')}</CardTitle>
                        <CardDescription>{t('analyzeCurrent.description')}</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="p-4 border rounded-lg bg-card">
                            <h3 className="font-semibold mb-2 text-foreground">{t('common.whatYouNeed')}</h3>
                            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                                <li>{t('analyzeCurrent.requirement1')}</li>
                                <li>{t('common.goodLighting')}</li>
                                <li>{t('common.referenceOptional')}</li>
                            </ul>
                        </div>
